...
{
	/// <summary>
	/// 	A spring arm camera that follows a target and rotates around it
	/// </summary>
	[ExecuteAlways]
	public class SpringArm : MonoBehaviour
	{
		...
		private void Rotate()
		{
			...
			yaw += PlayerContext.LookDelta.x * mouseSensitivity * Time.deltaTime;
			// Decrement pitch by Mouse Y input
			pitch -= PlayerContext.LookDelta.y * mouseSensitivity * Time.deltaTime;
